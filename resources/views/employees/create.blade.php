                ...
                <div class="relative z-10 flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
                    <div>
                        ...
                        <h1 class="text-4xl lg:text-6xl font-black text-slate-900 leading-tight">
                            Tambah <span class="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-cyan-400">Karyawan</span>
                        </h1>

                        <p class="text-slate-500 mt-4 max-w-2xl">
                            Lengkapi profil karyawan untuk kebutuhan absensi, data HR, dan scan wajah.
                        </p>
                    </div>
                    ...
                    <div class="employee-form rounded-[2.5rem] bg-white/90 backdrop-blur-2xl shadow-xl border border-white p-8 xl:sticky xl:top-8">
                        ...
                        <div class="flex flex-col items-center text-center">
                            <div class="relative">
                                <div class="relative">
                                    <img id="previewImage"
                                        src="https://ui-avatars.com/api/?name={{ urlencode(old('name', 'Employee')) }}&background=0ea5e9&color=fff"
                                        class="w-36 h-36 rounded-full object-cover shadow-2xl border-4 border-white">

                                    <div class="absolute -right-2 bottom-4 w-12 h-12 rounded-2xl bg-white shadow-xl flex items-center justify-center text-blue-600">
                                        📷
                                    </div>
                                </div>
                            ...
                            <p class="text-slate-400 mt-2 text-sm leading-relaxed">
                                Foto ini nanti dipakai sebagai data awal untuk proses scan wajah.
                            </p>

                            <label class="mt-6 w-full cursor-pointer">
                                <input type="file"
                                    name="photo"
                                    id="photoInput"
                                    accept="image/*"
                                ...
                                <div class="w-full px-6 py-4 rounded-2xl bg-blue-50 text-blue-600 font-black hover:bg-blue-100 transition text-center">
                                    Upload Foto
                                </div>
                            </label>
                        </div>
                ...
                <div class="xl:col-span-2">
                    <div class="employee-form rounded-[2.5rem] bg-white/90 backdrop-blur-2xl shadow-xl border border-white p-6 lg:p-8">
                        ...
                        <div class="mb-8">
                            ...
                            <p class="text-slate-400 mt-1">Masukkan data identitas karyawan.</p>
                        </div>
                        ...
                        <div class="flex flex-col sm:flex-row gap-4 pt-10">
                            ...
                            <a href="{{ route('employees.index') }}"
                               class="inline-flex items-center justify-center gap-2 px-8 py-4 rounded-2xl bg-slate-100 text-slate-600 font-black hover:bg-slate-200 transition">
                                Batal
                            </a>
                        </div>
